...
MAIN_PACKAGE = "maths2"
DESCRIPTION = "Sample project to try out Travis and Coveralls with PyScaffold"
LICENSE = "new-bsd"
URL = "None"
...
# Add here console scripts like ['hello_world = maths2.module:function']
CONSOLE_SCRIPTS = []
